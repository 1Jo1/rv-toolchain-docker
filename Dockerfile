...
RUN DEBIAN_FRONTEND=noninteractive TZ=Etc/UTC apt-get install -y wget tar software-properties-common python3.9 python3-venv python3-pip ninja-build pkg-config glib2.0 pixman
...
RUN cd qemu-8.1.1 && ./configure --target-list=riscv64-softmmu 
